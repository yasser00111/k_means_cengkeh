<nav class="navbar navbar-expand navbar-dark bg-dark ">
    ...
    <a class="navbar-brand mr-1" href="<?php echo site_url('mahasiswa/_partials') ?>">SPK DOSEN PEMBIMBING SKRISPI</a>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fas fa-user-circle fa-fw"></i> <?php foreach ($mahasiswa as $k) {
                                                                if ($k->id == $_GET['id']) {
                                                                    echo $k->nama;
                                                                }
                                                            } ?>
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                ...
                <p style="text-align:center;">
                    <i class="fas fa-user-circle fa-fw" style="text-align: center;font-size: 50px;"> </i></br> <?php foreach ($mahasiswa as $k) {
                                                                                                                    if ($k->id == $_GET['id']) {
                                                                                                                        echo $k->nama;
                                                                                                                    }
                                                                                                                } ?></p>
